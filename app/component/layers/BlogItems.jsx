    ...
    <div className="w-full">
      ...
      <div className="mt-5">
        ...
        <p className="font-normal text-sm leading-[175%] text-[#666] max-w-[816px] mb-[33px]">
          Donec at nunc et felis vehicula imperdiet. Aliquam ac nulla id purus
          lacinia imperdiet commodo sit amet nunc. Interdum et malesuada fames
          ac ante ipsum primis in faucibus. Aenean ultricies et risus in porta.
          Nam finibus, nisl ut sodales ultrices, libero urna condimentum tortor,
          a commodo tortor tortor a...
        </p>
        <Link
          href="#"
