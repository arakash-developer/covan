...
const MyLi = ({
  ...
  return (
    <li className="group w-full md:w-auto">
      ...
      <div className="dropdown md:w-[96%] bg-slate-100 md:absolute left-0 md:left-1/2 md:-translate-x-1/2 top-0 md:top-[100%] z-[999999] invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-300 ease-linear px-10 bg-sale bg-cover bg-top bg-no-repeat md:py-10 overflow-y-scroll md:max-h-[85vh] no-scrollbar h-0 md:h-auto group-hover:h-[60vh] md:group-hover:h-[80vh] cursor-pointer">
